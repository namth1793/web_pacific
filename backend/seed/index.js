...
// Remove old DB to force re-seed
const DATA_DIR = path.join(__dirname, '../data');
const DB_PATH = path.join(DATA_DIR, 'web_pacific.db');
...
function clearTables() {
  ...
  db.exec(`
    ...
    DELETE FROM users;
    DELETE FROM sqlite_sequence WHERE name IN ('test_results','comments','articles','programs','research','tests','contacts','users');
  `);
